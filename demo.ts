...
export module demo {
  ...
  export const FDEMO_NOINTERP = (1 << 2);	// don't interpolate between this an last view

  export const TEAM_UNASSIGNED = 0;
  export const TEAM_SPECTATOR = 1;
  export const TEAM_TERRORISTS = 2;
  export const TEAM_CTS = 3;

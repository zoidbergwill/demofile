import { CCSUsrMsg_AchievementEvent, CCSUsrMsg_AdjustMoney, CCSUsrMsg_AmmoDenied, CCSUsrMsg_BarTime, CCSUsrMsg_CallVoteFailed, CCSUsrMsg_ClientInfo, CCSUsrMsg_CloseCaption, CCSUsrMsg_CloseCaptionDirect, CCSUsrMsg_CurrentTimescale, CCSUsrMsg_Damage, CCSUsrMsg_DesiredTimescale, CCSUsrMsg_DisconnectToLobby, CCSUsrMsg_DisplayInventory, CCSUsrMsg_Fade, CCSUsrMsg_GameTitle, CCSUsrMsg_Geiger, CCSUsrMsg_GlowPropTurnOff, CCSUsrMsg_HintText, CCSUsrMsg_HudMsg, CCSUsrMsg_HudText, CCSUsrMsg_ItemDrop, CCSUsrMsg_ItemPickup, CCSUsrMsg_KeyHintText, CCSUsrMsg_KillCam, CCSUsrMsg_MarkAchievement, CCSUsrMsg_MatchEndConditions, CCSUsrMsg_MatchStatsUpdate, CCSUsrMsg_PlayerStatsUpdate, CCSUsrMsg_ProcessSpottedEntityUpdate, CCSUsrMsg_QuestProgress, CCSUsrMsg_RadioText, CCSUsrMsg_RawAudio, CCSUsrMsg_ReloadEffect, CCSUsrMsg_ReportHit, CCSUsrMsg_RequestState, CCSUsrMsg_ResetHud, CCSUsrMsg_RoundBackupFilenames, CCSUsrMsg_Rumble, CCSUsrMsg_SayText, CCSUsrMsg_SayText2, CCSUsrMsg_SendAudio, CCSUsrMsg_SendLastKillerDamageToClient, CCSUsrMsg_SendPlayerItemDrops, CCSUsrMsg_SendPlayerItemFound, CCSUsrMsg_ServerRankRevealAll, CCSUsrMsg_ServerRankUpdate, CCSUsrMsg_Shake, CCSUsrMsg_ShowMenu, CCSUsrMsg_StopSpectatorMode, CCSUsrMsg_TextMsg, CCSUsrMsg_Train, CCSUsrMsg_VGUIMenu, CCSUsrMsg_VoiceMask, CCSUsrMsg_VoteFailed, CCSUsrMsg_VotePass, CCSUsrMsg_VoteSetup, CCSUsrMsg_VoteStart, CCSUsrMsg_WarmupHasEnded, CCSUsrMsg_XpUpdate, CCSUsrMsg_XRankGet, CCSUsrMsg_XRankUpd, ECstrike15UserMessages } from "./protobufs/cstrike15_usermessages";
import { CNETMsg_Disconnect, CNETMsg_File, CNETMsg_NOP, CNETMsg_PlayerAvatarData, CNETMsg_SetConVar, CNETMsg_SignonState, CNETMsg_SplitScreenUser, CNETMsg_StringCmd, CNETMsg_Tick, CSVCMsg_BSPDecal, CSVCMsg_ClassInfo, CSVCMsg_CmdKeyValues, CSVCMsg_CreateStringTable, CSVCMsg_CrosshairAngle, CSVCMsg_EncryptedData, CSVCMsg_EntityMsg, CSVCMsg_FixAngle, CSVCMsg_GameEvent, CSVCMsg_GameEventList, CSVCMsg_GetCvarValue, CSVCMsg_HltvReplay, CSVCMsg_Menu, CSVCMsg_PacketEntities, CSVCMsg_PaintmapData, CSVCMsg_Prefetch, CSVCMsg_Print, CSVCMsg_SendTable, CSVCMsg_ServerInfo, CSVCMsg_SetPause, CSVCMsg_SetView, CSVCMsg_Sounds, CSVCMsg_SplitScreen, CSVCMsg_TempEntities, CSVCMsg_UpdateStringTable, CSVCMsg_UserMessage, CSVCMsg_VoiceData, CSVCMsg_VoiceInit, NET_Messages, SVC_Messages } from "./protobufs/netmessages";

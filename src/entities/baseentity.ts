 ...
 */
export class BaseEntity<Props extends CBaseEntity = CBaseEntity> extends Networkable<Props> {
  /**
  ...
  get moveParent(): BaseEntity | null {
    ...
    return this._demo.entities.getByHandle(this.getProp("DT_BaseEntity", "moveparent")) as unknown as BaseEntity | null;
  }
  ...
  get owner(): BaseEntity | null {
    ...
    return this._demo.entities.getByHandle(this.getProp("DT_BaseEntity", "m_hOwnerEntity")) as unknown as BaseEntity | null;
  }
